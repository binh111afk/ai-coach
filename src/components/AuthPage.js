        ...
        <div class="w-full max-w-md mx-auto my-auto py-4">
          ...
          <div id="loginView" class="auth-view ${initialView === 'loginView' ? '' : 'hidden'}">
            ...
            <div class="grid grid-cols-2 gap-3">
              <button type="button" class="btn-social-mock auth-btn-ghost py-3 rounded-2xl font-bold text-xs sm:text-sm text-gray-700 flex items-center justify-center gap-2">
                <i data-lucide="chrome" class="w-4 h-4 text-rose-500"></i> Google
              </button>
              <button type="button" class="btn-social-mock auth-btn-ghost py-3 rounded-2xl font-bold text-xs sm:text-sm text-gray-700 flex items-center justify-center gap-2">
                <i data-lucide="apple" class="w-4 h-4 text-gray-900"></i> Apple
              </button>
            </div>
