...
export function renderProviderIcon(modelId = '') {
  ...
  // 11. Mistral AI / Codestral / Devstral / Ministral
  if (mid.includes('mistral') || mid.includes('codestral') || mid.includes('devstral') || mid.includes('ministral')) {
    return `<svg height="20" width="20" style="flex:none;line-height:1;display:inline-block;vertical-align:middle;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Mistral AI</title><path d="M3 3h4v4H3V3zm14 0h4v4h-4V3zM3 8h18v4H3V8zm0 5h4v3H3v-3zm7 0h4v3h-4v-3zm7 0h4v3h-4v-3zm-14 4h4v4H3v-4zm7 0h4v4h-4v-4zm7 0h4v4h-4v-4z" fill="#FF7000"/></svg>`;
  }
